...
[![Live Demo](https://img.shields.io/badge/Live_Demo-Active-success)](https://white-axe.vercel.app/)
[![Next.js 16](https://img.shields.io/badge/Next.js_16-Turbopack-000000?logo=nextdotjs&logoColor=white)](https://nextjs.org)
[![React](https://img.shields.io/badge/React_19-20232A?logo=react&logoColor=61DAFB)](https://react.dev)
[![FastAPI](https://img.shields.io/badge/FastAPI-AI_Core-009688?logo=fastapi&logoColor=white)](https://fastapi.tiangolo.com)
...
- **Ebbinghaus Spaced Repetition** -- Employs mathematical decay curves to schedule timely revision queues before knowledge decays.
...
```mermaid
graph TD
    A[Teacher Baseline Hypothesis & Student Passion] --> B[FastAPI AI Core Engine]
    B --> C[LangChain Prompt Contextualizer]
    C --> D[Adaptive Challenge Arena]
    D -->|Student Completes Assessment| E[AI Scoring & Mastery Evaluation]
    E --> F{Compare AI Metric vs Teacher Hypothesis}
    F --> G[Calculate Optimal Mastery Tier]
    G --> H[(Supabase Database Sync)]
    H --> I[Teacher Co-Pilot Dashboard & Spaced Revision]
```
